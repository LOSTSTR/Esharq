...
> **كلمة شكر واحترام**
>
> أنا مبتدئ وما زلت أتعلّم وأجرّب، وإذا وجدت أي مشكلة أتمنى منك إخباري.
>
...
* **DiscordArabicizer** — *من تطوير اشراق*
  * *تعريب واجهة ديسكورد نفسها:* يترجم نصوص واجهة ديسكورد الأصلية — القوائم والأزرار والإعدادات والمهام والإشعارات — إلى عربية فصيحة، مع إبقاء الأسماء العَلَم (الألعاب والثيمات وأسماء المستخدمين) بلغتها الأصلية. تجربة عربية متكاملة من تطوير اشراق.
* **NitroSniper**
...
* **PerformanceBoost**
  * *وضع الأداء/الألعاب:* يخفض استهلاك المعالج والذاكرة أثناء اللعب بضغطة زرّ — يعطّل الحركات والانتقالات، ويضغط الرسائل، ويوقف تشغيل الصور المتحركة (GIF)، ويخفض أولوية كل عمليات Discord إلى Below Normal (ويندوز)، وينظّف الكاش — وكلّه قابل للعكس بالكامل. يعمل يدوياً عبر زرّ في شريط الرأس أو تلقائياً عند بدء لعبة، مع احترام إيقافك اليدوي (يبقى مُعطَّلاً حتى تُعيد تفعيله بنفسك). تعطيل تسريع العتاد يتطلب تبديلاً يدوياً مرّة وإعادة تشغيل Discord.
* **ConsoleWatcher**
  * *مسجّل أخطاء الكونسول (أداة مطوّر):* يسجّل أحداث الكونسول والأخطاء **أثناء التسجيل فقط** عبر زرّ في شريط الرأس — بلا هوك دائم وبلا استهلاك للموارد عند الخمول. اضغط الزرّ ليبدأ (يصير أحمر)، كرّر المشكلة، ثم أوقفه لتنبثق نافذة بكل الأحداث وترويسة سياق (إصدار العميل، رقم بناء ديسكورد، النظام، الأعداد) مع نسبة كل حدث لمصدره ورقائق تصفية حسب المصدر وعدّ أخطاء لكل مصدر، ونسخ الأخطاء فقط أو الكل. يلتقط كل دوال console وأخطاء النافذة بمُسلسِل آمن (يعالج المراجع الدائرية وعناصر DOM) ويلتقط أثر الخطأ (stack) وينظّف ضوضاء التنسيق — لتسهيل الصيانة والإبلاغ عن الأخطاء.
