...
const settings = definePluginSettings({
    hideGroups: {
        ...
        description: t("إخفاء الرسائل الجماعية أيضاً أثناء البثّ", "Hide Group DMs too while streaming"),
        default: false
    },
    debugMode: {
        type: OptionType.BOOLEAN,
        description: t("وضع التصحيح — يعرض سجلّات مفصّلة في الطرفية", "Debug Mode - Shows detailed logs in the console"),
        default: false
    }
});
