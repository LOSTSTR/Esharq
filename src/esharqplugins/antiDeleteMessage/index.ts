...
const settings = definePluginSettings({
    enabled: {
        ...
        description: t("تفعيل استعادة الرسائل تلقائياً", "Enable automatic message restoration"),
        default: true,
    },
    dmProtection: {
        type: OptionType.BOOLEAN,
        description: t("حماية الرسائل الخاصة أيضاً (لا السيرفرات فقط)", "Also protect DMs (not just servers)"),
        default: false,
    },
    maxCacheSize: {
        type: OptionType.NUMBER,
        description: t("أقصى عدد رسائل يُحتفظ بها في الذاكرة المؤقتة", "Maximum number of messages kept in cache"),
        default: 500,
    },
    serverBlacklist: {
        type: OptionType.STRING,
        description: t("معرّفات السيرفرات المُتجاهَلة (مفصولة بفواصل). الرسائل المُرسَلة فيها لن يُعاد إرسالها.", "Server IDs to ignore (comma-separated). Messages sent in these servers will NOT be resent."),
        default: "",
