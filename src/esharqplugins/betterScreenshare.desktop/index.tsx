...
export default definePlugin({
    ...
    start(): void {
        ...
        addSettingsPanelButton({
            ...
            get tooltipText() { return t("إعدادات مشاركة الشاشة · BetterScreenshare", "Screenshare settings · BetterScreenshare"); },
    ...
    toolboxActions: {
        [t("فتح إعدادات مشاركة الشاشة", "Open Screenshare Settings")]: openScreenshareModal
    },
    GoLivePanelWrapper,
