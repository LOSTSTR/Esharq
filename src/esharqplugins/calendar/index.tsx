            ...
            <div className={cl("note-header")}>
                ...
                <div className={cl("note-actions")}>
                    <button
                        ...
                        title={t("نسخ الطابع الزمني لديسكورد", "Copy Discord timestamp")}
                    >
                        <CopyIcon />
                    </button>
                    <button
                        ...
                        title={t("حذف الملاحظة", "Delete note")}
                    >
                        <TrashIcon />
                    </button>
                </div>
    ...
    return (
        <ModalRoot {...props} size={ModalSize.LARGE} className={cl("modal-root")}>
            <ModalHeader className={cl("modal-header")}>
                <span className={cl("modal-title")}>{t("التقويم", "Calendar")}</span>
