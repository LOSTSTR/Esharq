...
const settings = definePluginSettings({
    transitionDelay: {
        ...
        description: t("مدة الانتقال (مللي ثانية)", "Transition delay (ms)"),
        default: 60,
        onChange: () => applyCSS(),
    },
    animationType: {
        type: OptionType.SELECT,
        description: t("نوع الحركة", "Animation type"),
        options: [
    ...
    caretColor: {
        ...
        component: () => {
            ...
            return (
                <div>
                    <Forms.FormTitle tag="h3">{t("لون المؤشّر", "Caret color")}</Forms.FormTitle>
