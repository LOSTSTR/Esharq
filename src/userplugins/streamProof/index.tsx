...
const settings = definePluginSettings({
    autoStreamProof: {
        ...
        description: t("تفعيل StreamProof تلقائياً عند بدء البثّ", "Automatically enable StreamProof when you start streaming"),
        default: false,
        onChange(value) {
...
const StreamProofButton: ChatBarButtonFactory = ({ isMainChat }) => {
    ...
    const tooltip = active
        ? t("StreamProof: مُفعّل — انقر للتعطيل", "StreamProof: ON — click to disable")
        : t("StreamProof: مُعطّل — انقر للتفعيل", "StreamProof: OFF — click to enable");
