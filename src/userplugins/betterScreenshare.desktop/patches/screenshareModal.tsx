...
const ReplacedStreamSettings = () => {
    ...
    return (
        <div style={{ margin: "1em", display: "flex", flexDirection: "column", gap: "1em" }}>
            <SettingsModalCard cardProps={cardProps} title={t("إعدادات البثّ", "Stream Settings")}>
                <SettingsModalCardItem>
                    <Flex flexDirection="column">
                        <OpenScreenshareSettingsButton title={t("إعدادات متقدّمة", "Advanced Settings")} />
                    </Flex>
                </SettingsModalCardItem>
            </SettingsModalCard>
            <SettingsModalCard
                ...
                title={t("مصدر الصوت", "Audio Source")}>
                <SettingsModalCardItem>
