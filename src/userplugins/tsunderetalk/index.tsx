...
const TsundereTalkButton = ErrorBoundary.wrap(function TsundereTalkButton() {
    ...
    return (
        <HeaderBarButton
            ...
            tooltip={rewriteEnabled ? t("Tsundere Talk: مُفعّل", "Tsundere Talk: On") : t("Tsundere Talk: مُعطّل", "Tsundere Talk: Off")}
            aria-label={t("تبديل Tsundere Talk", "Toggle Tsundere Talk")}
