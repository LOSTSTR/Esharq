...
function TextReplace({ title, description, rulesArray, isRegex = false }: TextReplaceProps) {
    ...
    const scopeOptions = [
        { label: t("طبّق على رسائلك (يراها الجميع)", "Apply to your messages (visible to everyone)"), value: "myMessages" },
        { label: t("طبّق على رسائل الآخرين (تراها أنت فقط)", "Apply to others' messages (only visible to you)"), value: "othersMessages" },
        { label: t("طبّق على كل الرسائل", "Apply to all messages"), value: "allMessages" }
    ];
