            ...
            <Modal
                ...
                actionBarInput={
                    <div className={cl("summary")}>
                        <Text variant="text-md/semibold" color="text-strong" className={cl("source-or-preset-name")}>{liveSettings.contentHint === "motion" ? t("ألعاب", "Gaming") : liveSettings.contentHint === "detail" ? t("مشاركة شاشة", "Screenshare") : t("مخصّص", "Custom")}</Text>
                        <Text variant="text-xs/medium" color="text-muted" className={cl("summary-detail")}>
                            <span>{liveSettings.contentHint === "motion" ? t("فيديو أنعم", "Smoother video") : liveSettings.contentHint === "detail" ? t("نصّ أوضح", "Cleaner text") : t("إعدادٌ مخصّص", "User preset")}</span>
                    ...
                    <div>
                        ...
                        <div>
                            <OptionRadio
                                ...
                                labels={[t("فيديو أنعم", "Smoother video"), t("نصّ أوضح", "Cleaner text"), t("مخصّص", "Custom")]}
                                settings={liveSettings}
