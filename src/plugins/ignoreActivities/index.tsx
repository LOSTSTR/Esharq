...
function IdsListComponent(props: { setValue: (value: string) => void; }) {
    ...
    return (
        <section>
            <Heading tag="h3">{t("قائمة التصفية", "Filter List")}</Heading>
