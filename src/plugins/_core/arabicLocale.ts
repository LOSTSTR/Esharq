...
export default definePlugin({
    ...
    start() {
        ...
        //
        // 🔴 التحويل عبر `unknown` ضرورة لا تساهل: JSON المستورَد تُستنتَج
        // أجزاؤه مصفوفاتٍ (`(string|number)[]`) لا صفوفاً ثنائية، وما دامت في
        // الجدول رسالة **كلّها مواضع إدراج بلا نصّ** («{commandName}{commandText}»)
        // فلا تداخل بين النوعين ويرفض المُترجِم التحويل المباشر. والشكل مضمون
        // من مُولِّدنا نفسه: `buildArabicTable.mjs` يفحص كل جزء قبل الكتابة
        // ويفشل على أي شكل غير `نصّ` أو `[1, "اسم"]`.
