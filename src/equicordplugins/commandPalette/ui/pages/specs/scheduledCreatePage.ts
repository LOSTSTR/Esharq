...
const scheduledCreatePageSpec: PalettePageSpec = {
    ...
    fields: [
        { key: "channel", label: t("القناة", "Channel"), type: "picker", placeholder: t("القناة الحالية أو رسالة خاصّة أو محادثة جماعية", "Current channel, DM, or group DM"), suggestionLimit: LIMIT },
