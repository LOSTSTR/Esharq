        ...
        return (
            <div className={Margins.top16}>
                ...
                >
                    ...
                    >
                        {t("الأذونات المبسّطة", "Simplified permissions")}
                        <svg
...
const settings = definePluginSettings({
    simplifiedCard: {
        ...
        options: [
            { label: t("إخفاؤها", "Hide it"), value: "hide", default: true },
            { label: t("جعلها قابلة للطي", "Make it collapsible"), value: "collapse" },
            { label: t("إبقاؤها ظاهرة", "Leave it visible"), value: "show" },
        ],
    },
    collapsedByDefault: {
