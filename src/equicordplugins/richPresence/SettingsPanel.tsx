    ...
    return (
        <>
            ...
            <SelectSetting name="Album Art Mode" description="How to fetch album art." settingsKey="nd_albumArtMode" options={[
                { label: t("بلا", "None"), value: "none" },
                { label: t("خادم Navidrome (يكشف رابط الخادم. تُرسل بيانات دخول لمرّة واحدة.)", "Navidrome Instance (Exposes Server URL. One-time auth sent.)"), value: "instance" },
                { label: t("واجهة Last.fm (تُرسل البيانات الوصفية إلى last.fm)", "Last.fm API (Sends Metadata to last.fm)"), value: "lastfm" },
            ]} />
            ...
            <SelectSetting name="Activity Type" description="Which type of activity to display." settingsKey="nd_activityType" options={[
                { label: t("استماع", "Listening"), value: 2 },
                { label: t("لعب", "Playing"), value: 0 },
            ...
            <SelectSetting name="Status Display Type" description="Show the state / details line contents in the member list" settingsKey="nd_statusDisplayType" options={[
                { label: t("عدم الإظهار (يعرض رسالة استماع عامة)", "Don't show (shows generic listening message)"), value: "off" },
                { label: t("إظهار محتوى سطر الحالة", "Show state line content"), value: "artist" },
                { label: t("إظهار محتوى سطر التفاصيل", "Show details line content"), value: "track" }
            ]} />
